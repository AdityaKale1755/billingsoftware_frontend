    ...
    const completePayment = async (paymentMode) => {
      ...
      if (cartItems.length===0){
        ...
        const orderData = {
            ...
            tax,
            grandTotal,
            paymentMethod: paymentMode.toUpperCase(), // <-- Corrected here
        };
      ...
      try {
            ...
            if(response.status===201 && paymentMode==='cash'){
                toast.success("Your order has been successfully successfully!");
                setOrderDetails(savedData);
            }else if (response.status===401 && paymentMode==='upi'){
